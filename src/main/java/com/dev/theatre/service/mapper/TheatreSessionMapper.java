...
public class TheatreSessionMapper {
    ...
    @Autowired
    public TheatreSessionMapper(PerformanceService performanceService, TheatreStageService theatreStageService) {
    ...
    public TheatreSessionResponseDto toDto(TheatreSession theatreSession) {
        ...
        theatreSessionResponseDto.setTheatreStageCapacity(theatreSession.getTheatreStage().getCapacity());
    ...
    public TheatreSession fromDto(TheatreSessionRequestDto theatreSessionRequestDto) {
        ...
        theatreSession.setPerformance(performanceService.get(theatreSessionRequestDto.getMovieId()));
        theatreSession.setTheatreStage(theatreStageService.get(theatreSessionRequestDto.getCinemaHallId()));
        LocalDateTime localDateTime = LocalDateTime
                .parse(theatreSessionRequestDto.getShowTime(), DateTimeFormatter.ISO_LOCAL_DATE_TIME);
